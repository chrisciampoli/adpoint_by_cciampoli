                ...
                <div data-role="tabs" style="border:2px solid #590E0E;">
                    <div id="fragment-1">
                        <div height="100%" id="container">
                            <div id="employee_name" width="100%" class="info_box"><h2><?=  ucwords($name);?> - Cashier</h2></div>
                            <div id="current_date" width="100%" class="info_box"><h2><?php echo date('l F jS Y'); ?></h2></div>
                            <div id="assigned_work_area" width="100%" class="info_box"><h2>Section Working - Counter</h2></div>
